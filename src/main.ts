...
document.querySelector<HTMLDivElement>("#app")!.innerHTML = `
  <div>
    ...
    <div>
      ...
      <br>
      <input disabled id="connect-status"></input>
    </div>
    <div>
      <button id="switch-network-button">Switch Network</button>
      <br>
      <input disabled id="network-switch-status"></input>
    </div>
    <div>
      <button id="sign-msg-button">Sign Message</button>
      <br>
      <input disabled id="sign-msg-status"></input>
    </div>
    <div>
      <button id="call-contract-button">Call Contract</button>
      <br>
      <input disabled id="call-contract-status"></input>
    </div>
    <div>
      <button id="transfer-funds-button">Transfer Funds</button>
      <br>
      <input disabled id="transfer-funds-status"></input>
    </div>
    </div>
    <!--
